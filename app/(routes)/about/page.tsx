  ...
  return (
    <div className="max-w-7xl mx-auto py-2 sm:px-6 lg:px-8">
      <div className="bg-white overflow-hidden sm:rounded-lg">
        ...
        <div className="p-6">
          <h1 className="text-xl font-semibold text-gray-700 mb-2">Selamat datang di Rozic Sparepart!</h1>
          ...
          <div className="mt-4">
            ...
            <p className="text-gray-700">
              ...
              tinggi dan pelayanan pelanggan terbaik. Dengan berbagai pengalaman
              dan pengetahuan, kami telah tumbuh menjadi destinasi utama bagi
              pemilik kendaraan yang mencari suku cadang andal dan terpercaya.
              Kami bangga dapat berkontribusi pada mobilitas yang aman dan
              efisien bagi pelanggan kami."
            </p>
          </div>

          {/* Tambahkan sebanyak mungkin informasi yang diperlukan */}
        </div>
      </div>
    </div>
  );
